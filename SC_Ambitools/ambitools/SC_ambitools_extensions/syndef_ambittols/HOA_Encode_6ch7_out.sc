HOA_Encode_6ch7_out : Tmodule2 {

	*def
	{
		^SynthDef(\HOA_Encode_6ch7_out, {|in, out = 0, amp = 0, gatee = 1, in_ramp = 0.01, out_ramp = 0.01, xoffset = 0, yoffset = 0, zoffset = 0,  dopon = 0, dopamnt = 0, globTBus|
			var sig;
			var gain, coords, n=6;
			...
			sig = In.ar(in, n);
			sig = AmbisonicEncoder_in6.ar(7, sig, gain, coords);
	...
	*metadata
	{
		^(metadata: (
			synthdefname: "HOA_Encode_6ch7_out",
			type: \fx,
			main: \x,
			sliders: [
