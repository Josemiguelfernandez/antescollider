...
AuxConst16_2 {
	...
	*new {|gbus, channel, fadein, amp, group_out ... args|
		^super.newCopyArgs(gbus, channel, fadein, amp, *args).initTestargs(gbus, channel, fadein, amp, group_out, *args);
	}
...
/*		"group_audio_out1".postln;
		...
		group = Group.new(group_out, 'addBefore'); // addToTail porque es aux
...
/*		"bus".postln;
		...
		// outbus
		"1".postln;*/
		outsynth = AudioOut16.synth_group(group, bus, fadein, gbus, amp);
