HOA_Encode2_out : Tmodule2 {

	*def
	{
		^SynthDef(\HOA_Encode2_out, {|in, out = 0, outbus, outgain = 0, dist = 3, amp = 0, matrix_ramp = 0.01, gatee = 1, in_ramp = 0.01, out_ramp = 0.01, contr = 1, x = 0, y = 0, z = 0, dopon = 0, dopamnt = 0, el = 0, gbfbus, globTBus, llev = 0, glev = 0, sp = 0, df = 0, spk_radius = 2.5|
...
/*			foa = HPF.ar(foa, 20);
			...
			hoa_encoder = HOAEncoder.ar(2, sig, position.theta, position.phi, amp, 1, dis, spk_radius);
