HOA_Encode7_out : Tmodule2 {

	*def
	{
		^SynthDef(\HOA_Encode7_out, {|in, out = 0, gatee = 1, in_ramp = 0.01, out_ramp = 0.01, amp = 0, x = 0, y = 0, z = 0, dopon = 0, dopamnt = 0, el = 0, gbfbus, globTBus, plane_spherical = 1, spk_radius = 2.5, lo_freq = 50, lo_freq_gain = -40.0, compensation = 1, dist=1, azi=0, ele=0 |
			var sig;
			...
			*/
			...
			// hoa_encoder = AmbisonicEncoder.ar(sig, 0, dist, azi, ele);
