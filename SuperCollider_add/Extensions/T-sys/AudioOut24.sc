	...
	*def
	{
		...
		^SynthDef(\audioOut24, {|in, out = 0, outbus, gatee = 1, in_ramp = 0.01, out_ramp = 0.01, amp = 0, updateFreq = 10, pos = 0, width = 2, orientation = 0.5, peakLag = 2, index = -1|
			var sig;
			sig = In.ar(in, 24);
			//outbus = in;
