TSmoothDecimator8 : Tmodule2 {

	*def
	{


		^SynthDef(\tsmoothDecimator8, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, rate = 48000, smoothing = 0.5, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
	...
	*metadata
	{
		^(metadata: (
			synthdefname: "tsmoothDecimator8",
			type: \fx,
			main: \rate,
			sliders: [
