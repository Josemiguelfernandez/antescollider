	...
	*def
	{
		...
		^SynthDef(\tFriction8, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, friction = 0.5, spring = 0.414, damp = 0.313, mass = 0.1, beltmass = 1, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
