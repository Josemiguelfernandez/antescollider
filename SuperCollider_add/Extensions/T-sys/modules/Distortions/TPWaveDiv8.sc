TPWaveDiv8 : Tmodule2 {
	...
	*def
	{
		^SynthDef(\twaveDiv8, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1, lag = 0.2, div = 0,eq = 0.5, res = 0.01, jit = 0.1, jitF = 1, n = 0,
			lss = 0, am = 0|
