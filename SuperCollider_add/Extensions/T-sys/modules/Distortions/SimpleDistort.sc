SimpleDistort : Tmodule2 {

	*def
	{


		^SynthDef(\simpledistort, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, lowPassCutoff = 7000, highPassCutoff = 100, postDistCutoff = 18000, distAmt = 1, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
