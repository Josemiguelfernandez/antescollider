CompressorD : Tmodule2 {

	*def
	{
		^SynthDef(\CompressorD, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, thresh = 0.5, slopeBelow = 1.0, slopeAbove = 1.0, clampTime = 0.01, relaxTime = 0.1, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
