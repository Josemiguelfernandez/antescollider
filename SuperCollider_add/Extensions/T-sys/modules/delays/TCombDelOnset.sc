TCombDelOnset : Tmodule2 {

	*def
	{


	^SynthDef(\combDelOnset, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, amp = 0, startpos = 0, endpos = 2, decaytime = 0.5, thresh = 0.03, fastMul = 0.6, del = 0.3, matrix_ramp = 0.01, gate = 1, free = 1|
			var sig, envgate, envpause, cross, chain, bufsize, trig, trigrand, pos, dur, onsets;
			bufsize = 48000;
