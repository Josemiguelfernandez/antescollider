TCombC2Trig : Tmodule2 {

	*def
	{
		^SynthDef(\tCombC2Trig, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, att = 0.001, t_trig = 0, rel = 1, amp = 0, imp = 1, dectime = 0.3, deltime = 0.1, gentime = 3, matrix_ramp = 0.01, gate = 1, free = 1|
			...
			sig = CombC.ar(Decay2.ar(T2A.ar(t_trig), att, dectime, sig), 0.2, deltime, gentime);
