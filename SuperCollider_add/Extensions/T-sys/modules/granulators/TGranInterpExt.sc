	...
	*def
	{
		...
		^SynthDef(\TGranInterpExt, { |in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, envbuf = -1, dur = 0.25, t_trig = 0, durDev = 0, envbuf0 = 43, envbuf1 = 44, ifac = 0, pan = 0, panDev = 0, amp=0, ampDev = 0, matrix_ramp = 0.01, gate = 1, free = 1|
	...
	*metadata
	{
		^(metadata: (
			...
			sliders: [
				...
				\envbuf0 -> ControlSpec(0, 300, \lin,1, 43,\envbuf0),
				\envbuf1 -> ControlSpec(0, 300, \lin,1, 44,\envbuf1),
