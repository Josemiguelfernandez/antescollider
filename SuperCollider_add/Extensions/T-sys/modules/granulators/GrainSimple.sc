GrainSimple : Tmodule2 {


	*def
	{
		^SynthDef(\GrainSimple, { |out = 0, outbus = -2, trigRate = 1, amp=0, matrix_ramp = 0.01, buf, envbuf, pos = 0, loop = 0, t_trig = 0, rate = 1, env_dur = 1, gate = 1, free = 1|

			var sig, envgate, envpause, env;
			...
			// (SampleRate.ir/BufFrames.kr(envbuf)).reciprocal*env_dur.reciprocal.poll;
