TGranBuf8_Oneset : Tmodule2 {


	*def
	{
		^SynthDef(\TGranBuf8_Oneset, { |in = 0, out = 0, inbus, ingain = 0, outbus = -2, trigRate = 1, trigRateDev = 0, buf = 132, envbuf = -1, rate = 1.0, xFade = 1, thresh = 0.5, rateDev = 0, startPos= 0, centerDev = 0, dur = 0.25, durDev = 0, pan = 0, panDev = 0, amp=0, ampDev = 0, reset = 0, interpol = 2, matrix_ramp = 0.01, gate = 1, free = 1|
