TGranBuf_RecIn : Tmodule2 {


	*def
	{
		^SynthDef(\tGranBuf_Rec, { |in = 0, out = 22, outbus = -2, trigRate = 1, trigRateDev = 0, buf = 1, envbuf = -1, t_trig = 1, rate = 1.0, rateDev = 0, startPos= 0, centerDev = 0, dur = 0.25, durDev = 0, pan = 0, panDev = 0, amp=0, ampDev = 0, interpol = 2, matrix_ramp = 0.01, gate = 1, free = 1|
