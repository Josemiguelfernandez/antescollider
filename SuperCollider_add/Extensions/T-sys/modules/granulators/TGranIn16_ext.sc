TGranIn16_ext : Tmodule2 {

	*def
	{


		^SynthDef(\TGranIn16_ext, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = -120, xFade = 1, amp = 0, pos = 0, dur = 0.1, matrix_ramp = 0.01, gate = 1, free = 1, t_trig = 0, bufenv = -1|
			...
			sig = GrainIn.ar(16, t_trig, dur, sig, pos, bufenv);
			sig = Mix.ar(sig);
	...
	*metadata
	{
		^(metadata: (
			...
			menu: [
				\envitems -> [\bufenv, [-1,0,1, 2, 3, 4, 5, 6, 7]],
