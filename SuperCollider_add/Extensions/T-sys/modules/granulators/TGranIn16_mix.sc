TGranIn16_mix : Tmodule2 {

	*def
	{


		^SynthDef(\TGranIn16_mix, { |in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, trigRate = 1, trigRateDev = 0, envbuf = -1, dur = 0.25, durDev = 0, pan = 0, panDev = 0, amp=0, ampDev = 0, matrix_ramp = 0.01, gate = 1, free = 1|
			...
			sig = GrainIn.ar(16, trigRate2, dur, sig, pan, envbuf);
			sig = Mix.ar(sig);
