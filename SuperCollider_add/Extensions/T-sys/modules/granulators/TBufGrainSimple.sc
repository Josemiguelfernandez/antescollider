TBufGrainSimple : Tmodule2 {


	*def
	{
		^SynthDef(\bufGrainSimple, { |out = 0, outbus = -2, trigRate = 1, dur = 0.25, amp=0, matrix_ramp = 0.01, freq = 1, sndbuf = 858, envbuf = 48, gate = 1, free = 1|
			...
			sig = GrainBuf.ar(1, Impulse.kr(freq), dur, sndbuf, 1, 0, 2, 0, envbuf); //LFNoise2.kr(0.1).range(0, 1)
