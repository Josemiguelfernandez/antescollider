TGranFreeze8 : Tmodule2 {

	*def
	{


		^SynthDef(\TGranFreeze8, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = -120, xFade = 1, buf = 1, t_trig = 1, amp = 0, trate =  60, rate = 1, rateDev = 0, tratedev = 0, pan = 0, panDev = 0, dur = 0.1, durDev = 0.01, matrix_ramp = 0.02, startPos = 0.1, gate = 1, free = 1|
