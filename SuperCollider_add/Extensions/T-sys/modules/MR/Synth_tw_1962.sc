Synth_tw_1962 : Tmodule2 {

	*def
	{


	^SynthDef(\Synth_tw_1962, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, f1 = 811, f2 = 0.1, f3 = 855, f4 = 899, f5 = 5e-3, f6 = 5e-4,  amp = -20, matrix_ramp = 0.01, gate = 1, free = 1|
