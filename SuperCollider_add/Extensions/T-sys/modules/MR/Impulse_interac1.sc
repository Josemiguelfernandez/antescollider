Impulse_interac1 : Tmodule2 {

	classvar n = 4; //numero de componentes
	*def
	{

		^SynthDef(\impulse_interac1, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, x = 0, y = 0, amp = 0, width = 0.1,  matrix_ramp = 0.01, freq = 10, pitch = 1, gate = 1, free = 1|
