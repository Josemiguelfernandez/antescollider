Impulse_BPF : Tmodule2 {
	...
	*def
	...
	^SynthDef(\Impulse_BPF, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, freq = 14.5, freq_filter = 2791, rq = 0.195, gain = 2, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
