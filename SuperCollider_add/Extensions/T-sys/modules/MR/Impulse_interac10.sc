Impulse_interac10 : Tmodule2 {

	classvar n = 10; //numero de componentes
	*def
	{

		^SynthDef(\impulse_interac10, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, x = 0, y = 0, amp = 0,  matrix_ramp = 0.01, freq = 10, pitch = 1, width = 0.1, gate = 1, free = 1|
	...
	// Impulse_interac10.def

	*metadata
	{
		^(metadata: (
			synthdefname: "impulse_interac10",
			type: \gen,
			main: \freq,
			sliders: [
