SpecDel_Filt : Tmodule2 {
	// : TEffectModule
	*def
	{
		^SynthDef(\SpecDel_Filt, {|in = 0, out = 0, amp = 0, gate = 1, free = 1, matrix_ramp = 0.01, xFade = 1, fftsize = 1024, maxdel = 5, dels_buf, fb_buf, filt_buf, hop=0.25|
