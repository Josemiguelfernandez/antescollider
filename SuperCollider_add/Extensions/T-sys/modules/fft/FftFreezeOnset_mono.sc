FftFreezeOnset_mono : Tmodule2 {

	*def
	{


	^SynthDef(\fftFreezeOnset_mono, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = -120, xFade = 1, thresh = 0.5, amp = 0, winsize = 0.1, buf = 73, width = 2, orientation = 0.5, lag = 0.2, matrix_ramp = 0.01, gate = 1, free = 1|
...
/*			pos = TRand.kr(0, 2, onsets);
	...
	*metadata
	{
		^(metadata: (
			synthdefname: "fftFreezeOnset_mono",
			type: \fx,
			main: \amp,
			sliders: [
