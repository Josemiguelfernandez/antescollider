Tweets_fo_0143 : Tmodule2 {

	*def
	{


	^SynthDef(\Tweets_fo_0143, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, p1 = 8, p2 = 19.2, p3 = 0.111, amp = -20, matrix_ramp = 0.01, gate = 1, free = 1|
