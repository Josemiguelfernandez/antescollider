TBinPlayPvocBuf : Tmodule2 {


	*def
	{
		^SynthDef(\TBinPlayPvocBuf, { |out = 0, buf, loop = 0, fftSize=2048, window=1, doneAction = 2, rate=1, offset = 0, binStart = 0, binSkip = 1, numBins = 1,clear = 0 |
