TPlayBufEnvTrigFC : Tmodule2 {


	*def
	{
		^SynthDef(\TPlayBufEnvTrigFC, { |out = 0, buf, loop = 1, rate=1, envbuf, env_dur, impulse_rate = 1, freqHPF = 440, thresh = 0.5, slopeBelow = 1.0, slopeAbove = 1.0, clampTime = 0.01, relaxTime = 0.1, coef = 0.995|

			var in, sig, env, trig, comp;
	...
	*metadata
	{
		^(metadata: (
			synthdefname: "TPlayBufEnvTrigFC",
			type: \gen,
			main: \trigRate,
			sliders: [
