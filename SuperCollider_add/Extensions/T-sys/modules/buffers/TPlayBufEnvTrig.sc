TPlayBufEnvTrig : Tmodule2 {


	*def
	{
		^SynthDef(\TPlayBufEnvTrig, { |out = 0, buf, loop = 1, fftSize=2048, window=1, doneAction = 2, rate=1, offset = 0, envbuf, env_dur, impulse_rate = 1|
			var sig, env, trig;
