TBufRdEnvTrigFC : Tmodule2 {


	*def
	{
		^SynthDef(\TBufRdEnvTrigFC, { |out = 0, buf, loop = 1, rate=1, envbuf, env_dur, impulse_rate = 1, pos=0, freqHPF = 440, thresh = 0.5, slopeBelow = 1.0, slopeAbove = 1.0, clampTime = 0.01, relaxTime = 0.1, coef = 0.995|
