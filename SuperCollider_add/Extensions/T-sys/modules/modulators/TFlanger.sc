TFlanger : Tmodule2 {
	...
	*def
	{
		^SynthDef(\TFlanger, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, flangefreq = 0.1, ampmod = 0.005,lpfilt = 10000,  hpfilt = 50, fdback = 0.1, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
