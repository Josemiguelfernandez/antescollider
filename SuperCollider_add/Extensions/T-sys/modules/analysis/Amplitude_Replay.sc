Amplitude_Replay : Tmodule2 {

	*def
	{


	^SynthDef(\Amplitude_Replay, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, trig = 0, amp = 0, smask=0.25, tmask=1, id = 10, matrix_ramp = 0.01, gate = 1, free = 1, impulse_freq = 20, attackTime = 0.01, releaseTime = 0.01|
			...
			// onsets.poll;
			sig = Amplitude.kr(sigin, attackTime, releaseTime);

			SendReply.kr(Impulse.kr(impulse_freq), '/amplitude', sig, id);
