Pcile_Replay : Tmodule2 {

	*def
	{


	^SynthDef(\Pcile_Replay, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, trig = 0, amp = 0, id = 10, matrix_ramp = 0.01, gate = 1, free = 1, impulse_freq = 20|
			var sig, sigin, envgate, envpause, cross, chain, fftsize, pcile;
			...
			pcile = SpecPcile.kr(chain);
			// onsets.poll;

			SendReply.kr(Impulse.kr(impulse_freq), '/pcile', pcile, id);
