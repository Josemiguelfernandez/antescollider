FftOnsetReplay3 : Tmodule2 {

	*def
	{


	^SynthDef(\fftOnsetReplay3, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, trig = 0, amp = 0, winsize = 0.1, thresh = 1, relaxtime = 1, floor = 0.1, mingap = 10, filter_time = 0.01, medianspan = 11, whtype =  1, rawodf = 0, id = 10, matrix_ramp = 0.01, gate = 1, free = 1|
