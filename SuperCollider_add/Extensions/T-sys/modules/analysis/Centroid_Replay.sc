Centroid_Replay : Tmodule2 {

	*def
	{


	^SynthDef(\Centroid_Replay, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, trig = 0, amp = 0, id = 10, matrix_ramp = 0.01, gate = 1, free = 1, impulse_freq = 20|
			...
			SendReply.kr(Impulse.kr(impulse_freq), '/centroid', centroid, id);
