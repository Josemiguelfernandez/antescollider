VOsc3_wt_ste : Tmodule2 {

	*def
	{
		^SynthDef(\VOsc3_wt_ste, {|out = 0, buf, numBufs=2, freq=200, detune=0.2, amp=0, pan=0, rout=0, atk=0.01, sus=1, rel=0.01, c0=1, c1=(-1), in_ramp = 0.01, out_ramp = 0.01, gate = 1, free = 1|
