Osc_wt_HOA4 : Tmodule2 {

	*def
	{
		^SynthDef(\Osc_wt_HOA4, {|out = 0, buf, freq=200, detune=0.2, amp=0, pan=0, atk=0, sus=1, rel=0, c0=1, c1=(-1), in_ramp = 0.01, out_ramp = 0.01, gate = 1, free = 1, doneAction = 2,  x = 0, y = 0, z = 0, globTBus|
