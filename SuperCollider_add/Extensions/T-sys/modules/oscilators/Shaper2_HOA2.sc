Shaper2_HOA2 : Tmodule2 {

	*def
	{
		^SynthDef(\Shaper2_HOA2, {|out = 0, buf=0, freq=250, atk=1, sus=0, rel=5, c0=1, c1=(-1), curvemax=1, amp=0, in_ramp = 0.01, out_ramp = 0.01, gate = 1, free = 1, doneAction = 2,  x = 0, y = 0, z = 0, globTBus, lpf_freq = 5|
			var sig, envgate, envpause, input, curve, env, position, hoa_encoder;
			...
			hoa_encoder = HOAEncoder.ar(2, sig*env, position.theta, position.phi, 0, 1,position.rho); // amp in dB
