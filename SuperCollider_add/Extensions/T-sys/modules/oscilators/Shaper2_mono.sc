Shaper2_mono : Tmodule2 {

	*def
	{
		^SynthDef(\Shaper2_mono, {|out = 0, buf=0, freq=250, atk=1, sus=0, rel=5, curvemax=1, amp=0, in_ramp = 0.01, out_ramp = 0.01, gate = 1, free = 1|
