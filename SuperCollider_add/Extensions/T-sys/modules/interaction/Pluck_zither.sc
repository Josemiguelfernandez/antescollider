Pluck_zither : Tmodule2 {

	*def
	{


		^SynthDef(\pluck_zither, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, x = 0, y = 0, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
			...
			pitch = \freqs.kr([ 50, 53.86, 57.02, 59.69, 62, 64.04, 65.86, 67.51, 69.02, 71.69, 72.88, 74 ]);
