Form_lag_HOA_1 : Tmodule2 {

	*def
	{
		^SynthDef(\Form_lag_HOA_1, {|x = 0, y = 0, z = 0, globTBus, freq = 500, bpf = 1000, mul = 0, pan = 0.0, aamp = 1, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1, lag = 0.5|
			...
			hoa_encoder = HOAEncoder.ar(1, sig, Lag.kr(position.theta, lag), Lag.kr(position.phi, lag), amp, 1, Lag.kr(position.rho, lag),); // amp in dB
