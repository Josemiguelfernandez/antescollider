Form_HOA_5 : Tmodule2 {
	...
	*def
	{
		^SynthDef(\Form_HOA_5, {|x = 0, y = 0, z = 0, globTBus, freq = 500, bpf = 1000, mul = 0, pan = 0.0, aamp = 1, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
			...
			hoa_encoder = HOAEncoder.ar(5, sig, position.theta, position.phi, 0, 1,position.rho); // amp in dB
