	...
	*def
	{
		...
		^SynthDef(\TVbap8, {|in, out = 0, outbus, outgain = -120, gatee = 1, amp = 0, lag = 0.2, matrix_ramp = 0.05, gate = 1, free = 1, xFade = 1, buf = 172, azi = 0, ele = 1, spr = 0|
			...
			sig =  VBAP.ar(8, sig, buf, azi.lag(lag), ele.lag(lag), spr);
