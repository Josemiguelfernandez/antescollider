	...
	*def
	{
		...
		^SynthDef(\Vbap_4, {|in, out = 0, outbus, outgain = -120, gatee = 1, in_ramp = 0.01, out_ramp = 0.01, amp = 0, rad = 0.25, azi = 0, ele = 0, spr = 0, width = 60, vbapBuf, dopon = 0, dopamnt = 0, lag = 0, matrix_ramp = 0, gate = 1, free = 1, xFade = 1|
