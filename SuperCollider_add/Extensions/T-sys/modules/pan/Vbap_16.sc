	...
	*def
	{
		...
		^SynthDef(\Vbap_16, {|in, out = 0, outbus, outgain = -120, gatee = 1, in_ramp = 0.01, out_ramp = 0.01, amp = 0, azi = 0, ele = 0, spr = 0, width = 60, vbapBuf, lag = 0, matrix_ramp = 0, gate = 1, free = 1, xFade = 1|
			...
			sig = VBAP.ar(16, sig, vbapBuf, azi, ele, spr);
