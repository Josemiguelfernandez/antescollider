TMix8_Mono : Tmodule2  {
	...
	*def
	...
	^SynthDef(\TMix8_Mono, {|in, out = 0, outbus, outgain = -120, gatee = 1, in_ramp = 0.01, out_ramp = 0.01, amp = 0, updateFreq = 10, matrix_ramp = 0, gate = 1, free = 1, xFade = 1|
