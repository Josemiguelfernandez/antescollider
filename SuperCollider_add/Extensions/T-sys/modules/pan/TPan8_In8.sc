TPan8_In8 : Tmodule2  {
	...
	*def
	...
	^SynthDef(\TPan8_In8, {|in, out = 0, outbus, outgain = -120, gatee = 1, in_ramp = 0.01, out_ramp = 0.01, amp = 0, updateFreq = 10, pos = 0, width = 2, orientation = 0.5, peakLag = 0, index = -1, lag = 0.2, matrix_ramp = 0, gate = 1, free = 1, xFade = 1|
