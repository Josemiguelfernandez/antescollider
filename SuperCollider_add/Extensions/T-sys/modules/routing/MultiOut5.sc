MultiOut5 : Tmodule2  {
	...
	*def
	{
		^SynthDef(\MultiOut5, {|in = 0, out = 0, offset = 0, in_ramp = 0.01, out_ramp = 0.01, amp = 0, out_array = #[1, 1, 1, 1, 1], updateFreq = 10, peakLag = 0, index = -1, gatee = 1|
			var sig;
