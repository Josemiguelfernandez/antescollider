Laconicism_15_mono : Tmodule2 {

	*def
	{


	^SynthDef(\Laconicism_15_mono, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, freqMul = 1, numHarm = 1, ampRFreq = 16, ampExp = 9, fbMul = 100, dist = 1, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
	...
	*metadata
	{
		^(metadata: (
			synthdefname: "Laconicism_15_mono",
			type: \gen,
			main: \freqMul,
			sliders: [
