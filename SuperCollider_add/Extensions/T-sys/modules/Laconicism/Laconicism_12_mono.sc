Laconicism_12_mono : Tmodule2 {

	*def
	{


	^SynthDef(\Laconicism_12_mono, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, kFreq = 360, kBeat = 2, pFreq = 64, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
	...
	*metadata
	{
		^(metadata: (
			synthdefname: "Laconicism_12_mono",
			type: \gen,
			main: \kFreq,
			sliders: [
