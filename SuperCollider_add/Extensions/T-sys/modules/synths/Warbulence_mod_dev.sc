Warbulence_mod_dev : Tmodule2 {

	*def
	{
		^SynthDef(\Warbulence_mod_dev, {|out = 0, freq=200, amp=0, pan=0, in_ramp = 0.01, out_ramp = 0.01, gate = 1, free = 1, exp_line = 10|
			var sig, envgate, envpause, bufpos, env, devs, n, num;
		...
		*metadata
		{
			^(metadata: (
				synthdefname: "Warbulence_mod_dev",
				type: \gen,
				main: \freq,
				sliders: [
