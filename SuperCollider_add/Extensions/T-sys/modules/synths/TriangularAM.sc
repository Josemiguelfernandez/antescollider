TriangularAM : Tmodule2  {

	*def
	{


	^SynthDef(\TriangularAM, {|in, out = 0, outbus, outgain = -120, gatee = 1, in_ramp = 0.01, out_ramp = 0.01, amp = 0, freq = 440, modfreq = 5, matrix_ramp = 0, gate = 1, free = 1, xFade = 1|
			...
			sig = LFTri.ar(freq: freq, mul: modulator); // provides triangle wave for an interesting harmonic
