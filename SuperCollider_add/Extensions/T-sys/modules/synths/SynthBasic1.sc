SynthBasic1 : Tmodule2 {


	*def
	{
	^SynthDef(\SynthBasic1, {|out, outbus, outgain = 0, freq = 36, fc = 1000, rq = 0.25, d = 10, pos = 0, width = 2, orientation = 0.5, amp=0, sawwidth=0, matrix_ramp = 0.01, gate = 1, free = 1, lag = 0.2|
