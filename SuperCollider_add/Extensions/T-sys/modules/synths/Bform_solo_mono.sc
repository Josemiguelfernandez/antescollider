Bform_solo_mono : Tmodule2 {

	*def
	{
		^SynthDef(\Bform_solo_mono, {|out = 0, buf, numBufs=2, freq=200, formfreq = 70, bwfreq = 200, amp=0, pan=0, rout=0, atk=0.01, sus=1, rel=0.01, c0=1, c1=(-1), in_ramp = 0.01, out_ramp = 0.01, gate = 1, free = 1|
			...
			sig = Formant.ar(freq, formfreq * env.range(0.01,2), bwfreq);
			// sig = Mix.ar(sig);
