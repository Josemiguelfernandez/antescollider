HOA_Encode1 : Tmodule2 {

	*def
	{
		^SynthDef(\HOA_Encode1, {|in, amp = 0, x = 0, y = 0, z = 0, xoffset = 0, yoffset = 0, zoffset = 0, globTBus, buf, envbuf, pos = 0, loop = 0, t_trig = 0, rate = 1|
			...
			hoa_encoder = HOAEncoder.ar(1, sig, position.theta, position.phi, 0, 1,position.rho); // amp in dB ne marche pas
