HOA_Grain_xyz1 : Tmodule2 {

	*def
	{
		^SynthDef(\HOA_Grain_xyz1, {|amp = 0, x = 0, y = 0, z = 0, xoffset = 0, yoffset = 0, zoffset = 0, globTBus, buf, envbuf, pos = 0, loop = 0, t_trig = 0, rate = 1, env_dur = 1|
