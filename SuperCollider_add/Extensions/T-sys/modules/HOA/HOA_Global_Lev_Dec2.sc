HOA_Global_Lev_Dec2 : Tmodule2  {

	*def
	{
		^SynthDef(\HOA_Global_Lev_Dec2, {|in, out, gatee = 1, amp = 0, lag = 0.2, matrix_ramp = 0.05,  in_ramp = 0.01, out_ramp = 0.01, gate = 1, free = 1|
	...
	*metadata
	{
		...
		^(metadata: (
			synthdefname: "HOA_Global_Lev_Dec2",
			type: \fx,
			main: \azi,
			sliders:[
