VST_HOA_Insert4 : Tmodule2  {

	*def
	{
		^SynthDef(\VST_HOA_Insert4, {|in, out, globTBus, gatee = 1, amp = 0, lag = 0.2, matrix_ramp = 0.05, gate = 1, free = 1,  bypass = 0, xFade = 1|
			...
			sig = VSTPlugin.ar(sig, 25, bypass); // load IEM VST plugins
