HOA_Group1_out : Tmodule2  {
	...
	*def
	...
	^SynthDef(\HOA_Group1_out, {|in, out = 0, outbus, outgain = -120, gatee = 1, in_ramp = 0.01, out_ramp = 0.01, amp = 0, updateFreq = 10, pos = 0, width = 2, orientation = 0.5, peakLag = 2, index = -1, globTBus|
			var sig;
			sig = In.ar(in, 4);
			//outbus = in;
