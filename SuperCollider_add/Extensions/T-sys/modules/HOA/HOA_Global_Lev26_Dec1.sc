HOA_Global_Lev26_Dec1 : Tmodule2  {

	*def
	{
		^SynthDef(\HOA_Global_Lev26_Dec1, {|in, out, gatee = 1, amp = 0, lag = 0.2, matrix_ramp = 0.05,  in_ramp = 0.01, out_ramp = 0.01, gate = 1, free = 1|
			var sig, envgate, envpause, cross, convsig, b2a, a2b;

			sig = In.ar(in, 4);

			sig = HOADecLebedev26.ar(1, sig, hrir_Filters:1);
	...
	*metadata
	{
		...
		^(metadata: (
			synthdefname: "HOA_Global_Lev26_Dec1",
			type: \fx,
			main: \azi,
			sliders:[
