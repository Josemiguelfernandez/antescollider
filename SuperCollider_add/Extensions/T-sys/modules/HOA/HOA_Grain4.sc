HOA_Grain4 : Tmodule2 {
	...
	*def
	{
		^SynthDef(\HOA_Grain4, {|in, out = 0, outbus, outgain = 0, dist = 3, amp = 0, matrix_ramp = 0.01, gatee = 1, in_ramp = 0.01, out_ramp = 0.01, contr = 1, mx = 0, my = 0, mz = 0, dopon = 0, dopamnt = 0, el = 0, gbfbus, globTBus, llev = 0, glev = 0, sp = 0, df = 0, buf, envbuf, pos = 0, loop = 0, t_trig = 0, rate = 1, env_rate = 1, dis = 1, azim = 20|
...
/*			foa = HPF.ar(foa, 20);
			...
			hoa_encoder = HOAEncoder.ar(4, sig*env, azim, el, amp, 1, dis); // amp in dB
