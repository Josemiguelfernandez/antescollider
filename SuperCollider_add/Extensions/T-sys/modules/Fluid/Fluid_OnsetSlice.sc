Fluid_OnsetSlice : Tmodule2 {

	*def
	{


		^SynthDef(\Fluid_OnsetSlice, {|out = 0, in = 0, xFade = 1, trig = 0, amp = 0,  id = 10, matrix_ramp = 0.01, gate = 1, free = 1, metric = 9, threshold = 0.15, minSliceLength = 45, filterSize = 9, frameDelta = 0, windowSize = 128, hopSize = 64, fftSize = -1|
			var sig;
