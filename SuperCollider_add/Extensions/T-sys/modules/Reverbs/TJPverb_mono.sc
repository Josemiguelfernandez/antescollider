	...
	*def
	{
		...
		^SynthDef(\TJPverb_mono, {|in = 0, inbus, ingain = 0, out = 0, outbus, amp = 0, outgain = -120, t60 = 1, damp = 0, size = 1, earlyDiff = 0.707, modDepth = 0.1, modFreq = 2, low = 1, mid = 1, high = 1, lowcut = 500, highcut = 2000, matrix_ramp = 0.05, gate = 1, free = 1, xFade = 1|
