	...
	*def
	{
		...
		^SynthDef(\TGVerb_6, {|in = 0, out = 0, inlev = 0, amp = 0, roomsize = 10, revtime = 3, damping = 0.5, inputbw = 0.5, spread = 15, drylevel = 0, earlylevel = -3, taillevel = -6, maxroomsize = 300, matrix_ramp = 0.05, gate = 1, free = 1, xFade = 1|
