	...
	*def
	{
		...
		^SynthDef(\TFreeVerb, {|in = 0, inbus, ingain = 0, out = 0, outbus, inlev = -12, amp = 0, outgain = -120, roomsize = 0.15, mix = 0.33, damp = 0.5, inputbw = 0.5, spread = 15, drylevel = 0, earlylevel = -3, taillevel = -6, maxroomsize = 300, matrix_ramp = 0.05, gate = 1, free = 1, xFade = 1|
