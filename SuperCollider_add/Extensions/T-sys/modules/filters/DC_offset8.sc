DC_offset8 : Tmodule2 {
	...
	*def
	{
		^SynthDef(\dC_offset8, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, modfreq = 1, ampmod = 1, coef = 0.995, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
