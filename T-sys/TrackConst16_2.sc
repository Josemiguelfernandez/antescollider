...
TrackConst16_2 {
	...
	*new {|gbus, channel, fadein, amp, mix_group ... args|
	...
	initTestargs {|gbus, channel, fadein, amp, mix_group ... args|
		...
		// outbus.postln;
		// "server_toto".postln;
		outsynth = AudioOut16.synth_group(group, bus, fadein, outbus, amp);
	...
	gui {|track_name|
		...
		track = TTracks16.new(track_name.asString, nil, group, bus, outsynth);
