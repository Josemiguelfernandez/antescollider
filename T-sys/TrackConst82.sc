...
TrackConst82 {
	var <>outsynth, auxguindexincr, auxbusguindex, <>presetdico, presetpath, presetitems, buffer, <bus, <>group, <>addsynth, count, preset, outbus, <>module, <>temparams, <>tempmultiparams, <>track = nil;

	*new {|gbus, channel, fadein, amp, mix_group ... args|
		^super.newCopyArgs(gbus, channel, fadein, amp, mix_group, *args).initTestargs(gbus, channel, fadein, amp, mix_group, *args);
	}

	initTestargs {|gbus, channel, fadein, amp, mix_group ... args|
