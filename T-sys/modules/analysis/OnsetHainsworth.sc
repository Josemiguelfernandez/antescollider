OnsetHainsworth : Tmodule2 {

	*def
	{


	^SynthDef(\onsetHainsworth, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, trig = 0, amp = 0, winsize = 0.1, thresh = 1, waittime = 0.04, relaxtime = 1, id = 1000, matrix_ramp = 0.01, gate = 1, free = 1|
			...
			onsets = PV_HainsworthFoote.ar(chain, 1.0, 0.0, thresh, waittime);  //\mkl \rcomplex
			// onsets.poll;
