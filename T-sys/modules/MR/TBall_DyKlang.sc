	...
	*def
	{
		...
		^SynthDef(\tBall_DyKlang, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, gravity = 20, damp = 0.001, fric = 0.001, amp = 0,  matrix_ramp = 0.01, freq = 1, pitch = 1, width = 0.1, gate = 1, free = 1|
