TGrainEnv_8in_ext16 : Tmodule2 {

	*def
	{


		^SynthDef(\tGrainEnv_8in_ext16, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = -120, xFade = 1, buf = 1, amp = 0, trate =  60, rate = 1, rateDev = 0, tratedev = 0, pos = 0, panDev = 0, dur = 0.1, matrix_ramp = 0.01, startPos = 0.1, gate = 1, free = 1, t_trig = 0, centerpos = 0, bufenv = -1|
	...
	*metadata
	{
		^(metadata: (
			synthdefname: "tGrainEnv_8in_ext16",
			type: \fx,
			main: \amp,
			sliders: [
