	...
	*def
	{
		...
		^SynthDef(\Klanky, {|in = 0, inbus, ingain = 0, out = -1, outbus = -2, outgain = -120, transp = 1.0, amp = -12, d = 0, shift = 0, distor = 0, lfnoise_amp = 0.001, lfnoise_ring = 0.001, lag = 1, gate = 1, free = 1, matrix_ramp = 0.01, width = 2, dust_freq = 10, amp_fac = 1, orientation = 0, lag_spat = 0.2, xFade = 1|
		...
		//removed extra [] arround array vars since they are already arrays
			sig = DynKlank.ar(`[freqs,amps*amp_fac,rings], sig);
