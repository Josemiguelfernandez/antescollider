	...
	*def
	{
		...
		^SynthDef(\TPitch4, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, pitch1 = 1.0, pitch2 = 1.0, pitch3 = 1.0, pitch4 = 1.0, amp = -12, winsize = 0.1, matrix_ramp = 0.01, gate = 1, free = 1|
			...
			sig1 = PitchShift.ar(sig, winsize, pitch1.lag)* amp.dbamp.lag;
			sig2 = PitchShift.ar(sig, winsize, pitch2.lag)* amp.dbamp.lag;
			sig3 = PitchShift.ar(sig, winsize, pitch3.lag)* amp.dbamp.lag;
			sig4 = PitchShift.ar(sig, winsize, pitch4.lag)* amp.dbamp.lag;
