Tweets_jl_dark : Tmodule2 {
	...
	*def
	...
	^SynthDef(\Tweets_jl_dark, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, f1 = 10, f2 = 99, p1 = 0.2, p2 = 70, p3 = 99,p4 = 60, p5 = 0.1, amp = -20, matrix_ramp = 0.01, gate = 1, free = 1|
