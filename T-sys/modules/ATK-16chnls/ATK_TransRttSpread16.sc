ATK_TransRttSpread16 : Tmodule2 {

	*def
	{
		^SynthDef(\aTK_TransRttSpread16, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, angle = 1.5, dist = 3, azim = 0, rttFreq = 0.2, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
	...
	*metadata
	{
		^(metadata: (
			synthdefname: "aTK_TransRttSpread16",
			type: \fx,
			main: \azim,
			sliders: [
