ATK_TransPushX16 : Tmodule2 {

	*def
	{
		^SynthDef(\aTK_TransPushX16, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, angle = 1.5, dist = 3, azim = 0, elev = 0, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
...
/*			encoderMatrix = [
			...
			sig = FoaTransform.ar(sig, 'pushX', angle); //, (azim+22.5)*(pi/180), (elev+22.5)*(pi/180));
