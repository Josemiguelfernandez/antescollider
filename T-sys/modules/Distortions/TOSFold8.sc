TOSFold8 : Tmodule2 {
	...
	*def
	{
		^SynthDef(\tOsFold8, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1,
			...
			sig = OSFold4.ar(sig, lo.dbamp.lag(lag), hi.dbamp.lag(lag));
