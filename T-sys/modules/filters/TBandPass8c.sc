TBandPass8c : Tmodule2 {

	*def
	{
		^SynthDef(\tBandPass8c, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, freq = 440, rq = 1, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
