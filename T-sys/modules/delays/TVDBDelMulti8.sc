	...
	*def
	{
		...
		SynthDef(\vdbmulti8, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = -120, xFade = 1, wind_steep = 0.0005, buf_time = 10, lag_dels = 0, lag_amps = 0, amp = 0,  matrix_ramp = 0.01, gate = 1, free = 1|
