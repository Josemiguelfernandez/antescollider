FftBinShift : Tmodule2 {

	*def
	{


	^SynthDef(\fftBinShift, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, stretch = 1, shift = 0, interp = 0, amp = 0, winsize = 0.1, matrix_ramp = 0.01, gate = 1, free = 1|
