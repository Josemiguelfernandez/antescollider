TRingMod2 : Tmodule2 {
	...
	*def
	{
		^SynthDef(\tRingMod2, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, modfreq = 1, lpfilt = 10000,  hpfilt = 50, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
