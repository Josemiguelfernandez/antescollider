Noise_Brown : Tmodule2 {

	*def
	{


	^SynthDef(\Noise_Brown, {|in = 0, inbus, ingain = 0, out = 0, outbus, outgain = 0, xFade = 1, speed = 5, round = 10, amp = 0, matrix_ramp = 0.01, gate = 1, free = 1|
