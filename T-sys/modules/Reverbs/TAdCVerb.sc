	...
	*def
	{
		...
		^SynthDef(\TAdCVerb, {|in = 0, inbus, ingain = 0, out = 0, outbus, amp = 0, outgain = -120, revTime = 1, hfDamping = 0.1, predelay = 0.02, numCombs = 8, numAllpasses = 4, inFilter = 0.6, leakCoeff = 0.995, combScale = 1, apScale = 1, matrix_ramp = 0.05, gate = 1, free = 1, xFade = 1|
			...
			sig = AdCVerb.ar(sig *0.2, revTime: revTime.lag(0.5),
