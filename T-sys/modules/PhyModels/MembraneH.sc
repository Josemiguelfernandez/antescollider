MembraneH : Tmodule2 {
	...
	*def
	{
		^SynthDef(\MembraneH, {|out = -1, outbus = -2, amp = 0, t_trig = 0, sing_switch = 0, freq = 2434, amp_intern = 0.5, decayscale = 1, freq_fac = 1, lag = 1, envdur = 5, decay = 6, i_doneAction = 0, tension = 0.05, loss = 0.99999,  gate = 1, free = 1, matrix_ramp = 0.005, width = 2, orientation = 0, lag_spat = 0.2|
			...
			sig = MembraneHexagon.ar(input, tension, loss);
